...
def generate_decay_tree(
    num_left_children, num_right_children, root_mass, left_mass, right_mass, leaf_mass
):
    ...
    right = GenParticle("right", right_mass).set_children(
        *leaf_list[num_left_children:]
    )
