...
from ..layers import MLP, NRI_block, TransformerEncoder, ScaledDotProductAttention
from ..utils.data_utils import construct_rel_recvs, construct_rel_sends


class Set2TreeGAT(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.edge_transformer = TransformerEncoder(
            dim_feedforward * 2,
            2,
            mha_config={'num_heads' : 4, 'attention' : ScaledDotProductAttention, 'out_proj' : False},
            dense_config={'norm_layer' : nn.LayerNorm, 'activation': nn.SiLU, }
        )
