...
class NRIModel(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        initial_mlp = [
            MLP(infeatures, dim_feedforward, dim_feedforward, dropout, batchnorm)
        ]
        ...
        initial_mlp.extend(
            [
                ...
                for _ in range(initial_mlp_layers - 1)
            ]
        )
        ...
        self.pre_blocks_mlp = MLP(
            dim_feedforward * 2, dim_feedforward, dim_feedforward, dropout, batchnorm
        )
        ...
        if self.factor:
                                ...
                                [
                                    ...
                                    nn.Sequential(
                                        *[
                                            ...
                                            for _ in range(block_additional_mlp_layers)
                                        ]
                                    ),
            ...
            self.mlp3 = MLP(
                dim_feedforward, dim_feedforward, dim_feedforward, dropout, batchnorm
            )
            self.mlp4 = MLP(
                dim_feedforward * 2,
                dim_feedforward,
