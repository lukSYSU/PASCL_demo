...
def load_config(
    cfg_path=None, model=None, dataset=None, run_name=None, samples=None, **kwargs
):
    ...
    assert configs["dataset"]["source"] in [
        "phasespace"
    ], "Only phasespace dataset source is currently supported"
