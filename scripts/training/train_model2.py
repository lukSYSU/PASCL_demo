...
parser.add_argument('-c', '--config', dest='cfg_path', required=True,
              type=click.Path(exists=True), help='path to config file')
parser.add_argument('-r', '--run', dest='run_name', required=False,
              type=str, help='Name of run')
parser.add_argument('-s', '--samples', dest='samples', required=False,
...
parser.add_argument('-d', '--dataset', dest='dataset', required=False,
              type=int, help='Individual dataset to load')
parser.add_argument('-q', '--quiet', dest='log_level', default=True)
# parser.add_argument('-v', '--verbose', dest='log_level', flag_value=logging.INFO)
# parser.add_argument('-vv', '--very-verbose', dest='log_level', flag_value=logging.DEBUG)
